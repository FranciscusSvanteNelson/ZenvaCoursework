...
//   std::string firstName = "Franciscus";
//   std::string lastName = " Nelson";
...
// int main() {  
//   // printName("Franciscus");
//   // printName("Zenva");
//   // printName();
//   // std::string first = "Franciscus";
//   printFullName("Franciscus", " Nelson");
// }
...
// int main() {
//   std::string fullName = getFullName("Franciscus", " Nelson");
...
//   name = "Francescus";
//   name.insert(5, "i"); // Name now is "Franciescus"
//   name.erase(6, 1);
//   std::cout << name << std::endl; // Name is now "Franciscus"
// }